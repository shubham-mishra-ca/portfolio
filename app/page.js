    ...
    <>
        ...
        <nav>
            <ul id="menu" className={menuOpen ? "active" : ""}>
                ...
                <li>
                    <a href="mailto:smishra.on.ca@gmail.com" className="button">Contact Me</a>
                </li>
            </ul>
        ...
        <section className="hero container">
            <div className="hero-blue">
                <div>
                    ...
                    <p>
                        Design and Developer in Canada who creates educational ontent on YouTube to teach others about
                        HTML, CSS and Javascript. <span>I'm interested in AI topics which is why I also add things like
                    ...
                    <div className="call-to-action">
                        ...
                        <a href="mailto:smishra.on.ca@gmail.com" className="button white">
                            Contact Me
                        </a>
                    </div>

                    <div className="social-links">
                        <a href="https://github.com/shubham-mishra-ca">
                            <img src="./imgs/github.png" alt="GitHub" width="48" />
                        </a>
                        <a href="https://www.linkedin.com/in/shubham-mishra-ca/">
            ...
            <div className="hero-yellow">
                <img src="./imgs/hero-image.png" alt="Shubham Mishra" width="100%" />
            </div>
        ...
        <section id="skills" className="skills container">
            ...
            <div className="holder-blue">
                ...
                <div className="right-column">
                    ...
                    <p>
                        Hi I'm Shubham Mishra, a designer and developer who creates educational content on YouTube to
                        teach others about HTML, CSS and JavaScript. I'm interested in AI topics which is why I also add
                        things like ChatGPT into my projects these days!
                    </p>
                    <p>
                        I'm currently working on a project that uses Azure AI to create a chatbot that can help answer
                        questions about web development. I'm also working on a project that uses React and Next.js to
			...
			<div className="chatbot-blue">
				...
				<div className="chat-box">
					...
					<div className="chat-message">
						<input type="text" placeholder="Hey Shubham, what skills are you best at?" />
